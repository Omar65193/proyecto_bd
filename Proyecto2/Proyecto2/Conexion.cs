...
namespace Proyecto2
{
    class Conexion
    {
        ...
        public Conexion()
        {
            conexionstring = "Server=187.140.103.190;Initial Catalog=TAREA2_2;Persist Security Info=False;User ID=mario;Password=pasword;";
            conexion = new SqlConnection(conexionstring);
        }
        public static bool conectar()
        {
            string parametrosConexion = "server=87.140.103.190; Initial Catalog=TAREA2_2; database=TAREA2_2; Uid=mario; pwd=password;";
            try
            {
